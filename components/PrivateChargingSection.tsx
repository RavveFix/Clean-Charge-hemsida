...
const PrivateChargingSection: React.FC = () => {
    ...
    return (
        <div className="bg-white font-monta animate-in fade-in duration-500">
            {/* Hero */}
            <section className="relative pt-28 pb-16 sm:py-24 md:py-32 lg:py-40 bg-slate-50 overflow-hidden">
                ...
                <div className="container mx-auto px-4 sm:px-6 relative z-10 2xl:max-w-[1440px] 3xl:max-w-[1600px]">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-8">
                            ...
                            <h1 className="text-2xl sm:text-3xl md:text-[5rem] font-black text-slate-800 tracking-tighter uppercase leading-tight md:leading-[0.9]">
                                Ladda Hemma <br/> <span className="text-cc-green">Laddbox för Villa.</span>
                            </h1>
                            
                            <p className="text-base sm:text-xl text-slate-500 font-medium leading-relaxed max-w-xl">
                            ...
                            <div className="flex flex-col sm:flex-row gap-5 pt-4">
                                 <Link 
                                    href="/kontakt"
                                    className="inline-flex items-center justify-center bg-cc-green text-white px-6 sm:px-10 py-4 sm:py-5 rounded-full font-black uppercase tracking-widest hover:bg-slate-900 transition-all shadow-xl shadow-cc-green/20 hover:scale-105 active:scale-95 group text-sm sm:text-base"
                                >
                                 ...
                                 <button 
                                    ...
                                    className="bg-white text-slate-900 border-2 border-slate-100 px-6 sm:px-10 py-4 sm:py-5 rounded-full font-black uppercase tracking-widest hover:border-slate-900 transition-all hover:scale-105 active:scale-95 text-sm sm:text-base"
                                >
                                    Se Laddboxar
                                </button>
                            </div>
                            
                            <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-4 text-slate-400">
            ...
            <section className="py-16 sm:py-24 bg-slate-900 text-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 sm:px-6 flex flex-col md:flex-row items-center gap-10 sm:gap-16 relative z-10 2xl:max-w-[1440px] 3xl:max-w-[1600px]">
                    <div className="md:w-1/2 space-y-8">
                        ...
                        <h2 className="text-3xl sm:text-5xl md:text-6xl font-black mb-4 sm:mb-6 uppercase tracking-tight leading-[0.9]">
                            50% Avdrag <br />
                    ...
                    <div className="md:w-1/2">
                         <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-5 sm:p-6 md:p-10 rounded-[1.5rem] sm:rounded-[3rem] relative">
            ...
            <section id="products" className="py-16 sm:py-24 md:py-32">
                <div className="container mx-auto px-4 sm:px-6 2xl:max-w-[1440px] 3xl:max-w-[1600px]">
                    <div className="text-center mb-20 max-w-2xl mx-auto">
                        ...
                        <p className="text-slate-500 text-base sm:text-xl font-medium">Vi har valt ut marknadens bästa laddboxar för nordiskt klimat. Kompakta, säkra och uppkopplade.</p>
                    </div>
                 ...
                 <div className="container mx-auto px-4 sm:px-6 2xl:max-w-[1440px] 3xl:max-w-[1600px]">
                     <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
                         {[
                             ...
                             <div key={i} className="bg-white p-6 sm:p-8 md:p-12 rounded-[1.5rem] sm:rounded-[2rem] md:rounded-[3rem] shadow-sm border border-slate-100 hover:shadow-2xl hover:border-cc-green/20 transition-all duration-500 group">

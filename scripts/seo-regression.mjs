...
const priorityRoutes = [
  ...
  },
  {
    ...
    h1: /Lastbalansering för laddbox/i,
    links: ['/kontakt', '/privat', '/foretag', '/fastighetsbolag'],
    ogType: 'article',
  },
  {
    path: '/individuell-debitering-laddbox',
    h1: /Individuell.*debitering.*laddbox/i,
    links: ['/kontakt', '/fastighetsbolag', '/samfallighet', '/foretag', '/monta'],
    ogType: 'article',
  },
  {
    path: '/kunskap',
...
try {
  ...
  for (const [path, lastModified] of [
    ...
    ['/lastbalansering-laddbox', '2026-09-08'],
    ['/individuell-debitering-laddbox', '2026-09-08'],
    ['/monta', '2026-09-08'],

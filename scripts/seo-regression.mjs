...
const priorityRoutes = [
  ...
  {
    path: '/laddbox-brf',
    h1: /Laddbox till BRF.*lastbalansering.*debitering.*bidrag/i,
    links: ['/fastighetsbolag', '/kontakt', '/basta-laddboxen', '/ladda-bilen-bidrag'],
    ogType: 'article',
  },
  {
    path: '/fastighetsbolag/stockholm',
    h1: /Laddbox för BRF i Stockholm/i,
    links: ['/fastighetsbolag', '/kontakt', '/hela-sverige', '/monta'],
  },
  {
    path: '/fastighetsbolag/goteborg',
    h1: /Laddbox för BRF och hyresfastighet i Göteborg/i,
    links: ['/fastighetsbolag', '/kontakt', '/hela-sverige', '/monta'],
  },
  {
    path: '/fastighetsbolag/malmo',
    h1: /Laddbox för BRF i Malmö och Lund/i,
    links: ['/fastighetsbolag', '/kontakt', '/hela-sverige', '/monta'],
  },
  {
    path: '/kunskap',
...
try {
  ...
  for (const [path, lastModified] of [
    ['/', '2026-08-13'],
    ['/kunskap', '2026-08-13'],
    ['/laddbox-brf', '2026-08-19'],
    ['/fastighetsbolag/stockholm', '2026-08-19'],
    ['/fastighetsbolag/goteborg', '2026-08-19'],
    ['/fastighetsbolag/malmo', '2026-08-19'],

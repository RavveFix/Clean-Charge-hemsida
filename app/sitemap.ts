...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    { url: '/fastighetsbolag', priority: 0.9, changeFrequency: 'monthly' as const, lastModified: '2026-09-08' },
    { url: '/fastighetsbolag/stockholm', priority: 0.85, changeFrequency: 'monthly' as const, lastModified: '2026-08-17' },
    { url: '/fastighetsbolag/goteborg', priority: 0.85, changeFrequency: 'monthly' as const, lastModified: '2026-08-17' },
    { url: '/fastighetsbolag/malmo', priority: 0.85, changeFrequency: 'monthly' as const, lastModified: '2026-08-17' },
    { url: '/dc-laddstation', priority: 0.85, changeFrequency: 'monthly' as const, lastModified: '2026-06-22' },
    { url: '/monta', priority: 0.8, changeFrequency: 'monthly' as const, lastModified: '2026-09-08' },
    { url: '/laddbox-orebro', priority: 0.7, changeFrequency: 'monthly' as const, lastModified: '2026-07-03' },
    { url: '/kunskap', priority: 0.8, changeFrequency: 'monthly' as const, lastModified: '2026-09-08' },
    { url: '/laddbox-brf', priority: 0.8, changeFrequency: 'monthly' as const, lastModified: '2026-08-17' },
    { url: '/projektexempel-brf-laddning', priority: 0.78, changeFrequency: 'monthly' as const, lastModified: '2026-09-08' },
    { url: '/lastbalansering-laddbox', priority: 0.75, changeFrequency: 'monthly' as const, lastModified: '2026-09-08' },
    { url: '/individuell-debitering-laddbox', priority: 0.75, changeFrequency: 'monthly' as const, lastModified: '2026-09-08' },
    ...
    { url: '/publik', priority: 0.75, changeFrequency: 'monthly' as const, lastModified: '2026-09-08' },

...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    { url: '/ladda-bilen-bidrag', priority: 0.65, changeFrequency: 'monthly' as const, lastModified: '2026-07-05' },
    { url: '/samfallighet', priority: 0.8, changeFrequency: 'monthly' as const, lastModified: '2026-07-03' },
    { url: '/vad-kostar-laddbox', priority: 0.65, changeFrequency: 'monthly' as const, lastModified: '2026-07-05' },
    { url: '/basta-laddboxen', priority: 0.65, changeFrequency: 'monthly' as const, lastModified: '2026-07-05' },

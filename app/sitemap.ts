...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    { url: '/vad-kostar-laddbox', priority: 0.65, changeFrequency: 'monthly' as const, lastModified: '2026-07-03' },
    { url: '/basta-laddboxen', priority: 0.65, changeFrequency: 'monthly' as const, lastModified: '2026-07-03' },

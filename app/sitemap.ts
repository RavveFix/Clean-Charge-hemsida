...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    { url: '/fastighetsbolag/stockholm', priority: 0.7, changeFrequency: 'monthly' as const, lastModified: '2026-08-19' },
    { url: '/fastighetsbolag/goteborg', priority: 0.7, changeFrequency: 'monthly' as const, lastModified: '2026-08-19' },
    { url: '/fastighetsbolag/malmo', priority: 0.7, changeFrequency: 'monthly' as const, lastModified: '2026-08-19' },
    ...
    { url: '/laddbox-brf', priority: 0.75, changeFrequency: 'monthly' as const, lastModified: '2026-08-19' },
